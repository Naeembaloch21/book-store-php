...
<div class="container-fluid" style="background-color: #6767670c;">
    <div class="row ms-5">
        <div class="col-sm-4 mt-5 mb-5 d-flex">
            <img src="assets/images/icon-4.png" class="mt-3" alt="Error:404" width="60px" height="40px">
            <h3 class="ms-3">FREE SHIPPING <br> <span class="fs-5">Order over $100</span></h3>
        </div>
        <div class="col-sm-4 mt-5 mb-5 d-flex">
            <img src="assets/images/icon-3.png" class="mt-3" alt="Error:404" width="60px" height="40px">
            <h3 class="ms-3">SECURITY PAYMENT <br> <span class="fs-5">100% Secure payment</span></h3>
        </div>
        <div class="col-sm-4 mt-5 mb-5 d-flex">
            <img src="assets/images/icon-2.png" class="mt-3" alt="Error:404" width="60px" height="40px">
    ...
    <div class="row">
        <div class="col-sm-12 d-flex justify-content-center mt-5">
            ...
            <button class="text-dark bg-danger border-0 ms-3 pt-4 pb-4 shadow p-3 mb-5 bg-body rounded">COOK
                BOOK</button>
            <button class="text-dark bg-danger border-0 ms-3 pt-4 pb-4 shadow p-3 mb-5 bg-body rounded">History</button>
            <button class="text-dark bg-danger border-0 ms-3 pt-4 pb-4 shadow p-3 mb-5 bg-body rounded">Fantasy</button>
            <button class="text-dark bg-danger border-0 ms-3 pt-4 pb-4 shadow p-3 mb-5 bg-body rounded">Romance</button>
        </div>
    </div>
</div>
<div class="container-fluid">
    <div class="row" id="gridRow">
        <div class="col-12 col-md- 6 col-lg-3 text-center ">
            <a href="Details Pages/Details4.htm">
                <img src="assets/images/1.webp" width="100%" alt="Error:404">
            </a>
            <h3>MICHAEL ALICE</h3>
            ...
            <a href="table.htm">
                <button class="border-0 bg-danger text-light p-2 mb-3 mt-3">ADD TO CARD</button>
            </a>
        </div>
        <div class="col-12 col-md-6 col-lg-3 text-center">
            <a href="Details Pages/Details1.htm">
                <img src="assets/images/Screenshot 2023-05-03 102328.png" alt="Error:404">
            </a>
            <h3>ADAM BAID</h3>
        ...
        <div class="col-12 col-md-6 col-lg-3 text-center">
            <a href="Details Pages/Details2.htm">
                <img src="assets/images/Screenshot 2023-05-03 102430.png" alt="Error:404">
            </a>
            <h3>JOHN ERIK</h3>
        ...
        <div class="col-12 col-md-6 col-lg-3 text-center">
            <a href="Details Pages/Details3.htm">
                <img src="assets/images/Screenshot 2023-05-03 102510.png" alt="Error:404">
            </a>
            <h3>ALICE JAMES</h3>
...
<div class="container-fluid mt-5">
    <div class="row" id="demo">
        <div class="col-12 col-md-6 col-lg-3 text-center">
            <a href="Details Pages/Details4.htm">
                <img src="assets/images/4.png" alt="Error:404">
            </a>
            <h3>MICHAEL ALICE</h3>
            <h4>Last Time We Broke Up</h4>
            <h3>$500.00</h3>
        ...
        <div class="col-12 col-md-6 col-lg-3 text-center ">
            <a href="Details Pages/Details5.htm">
                <img src="assets/images/2.png" alt="Error:404">
            </a>
        ...
        <div class="col-12 col-md-6 col-lg-3 text-center">
            <a href="Details Pages/Details6.html">
                <img src="assets/images/3.png" alt="Error:404">
            </a>
            <h3>MICHAEL ALICE</h3>
        ...
        <div class="col-12 col-md-6 col-lg-3 text-center">
            ...
            <a href="table.htm">
                <button class="border-0 bg-danger text-light p-2 mt-3">ADD TO CARD</button>
            </a>
        </div>
    </div>
</div>
